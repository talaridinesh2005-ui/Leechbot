...
from bot.helper.ext_utils.task_manager import start_from_queued, is_queued_up
...
class MirrorLeechListener:
    ...
    async def onDownloadComplete(self):
        ...
        added_to_queue, event = await is_queued_up(self.uid, self.message.from_user.id)
        if added_to_queue:
            async with download_dict_lock:
